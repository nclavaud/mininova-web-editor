...
test('build a NRPN sequence', () => {
  const expected = [[0xB0, 0x63, 0], [0xB0, 0x62, 122], [0xB0, 0x06, 47]];
...
test('build a sysex sequence', () => {
  const expected = [[0xF0, 0x00, 0x20, 0x29, 0x03, 0x01, 0x7F, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF7]];
